      ...
      >
        ...
        <div className="p-3 sm:p-6">
          {loading ? (
            ...
            <>
              {/* هدر اطلاعات فاکتور */}
              <div className="bg-gradient-to-r from-primary-soft to-surface rounded-card shadow-sm border border-primary-soft p-4 sm:p-6 mb-4 sm:mb-6">
              ...
              <div className="bg-surface shadow rounded-field p-4 sm:p-6 mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  <div>
                    ...
                    <p className="text-body-sm font-medium text-text-primary font-mono">
                      {invoice.invoice_number}
                    </p>
                  </div>
                  <div>
                ...
                {invoice.note && (
                  <div className="mt-4 pt-4 border-t border-border">
                    ...
                    <p className="text-body-sm text-text-primary bg-surface-alt p-2 rounded-field">
                      {invoice.note}
                    </p>
                  </div>
                )}
                ...
                {invoice.device_id && (
                  <div className="mt-4 pt-4 border-t border-border">
                    <h4 className="text-body-sm font-medium text-text-primary mb-3 flex items-center gap-2">
                ...
                <div className="lg:col-span-9">
                  <div className="bg-surface shadow rounded-field p-3 sm:p-4">
                    ...
                    {invoice.items?.length === 0 ? (
                      <div className="text-center py-8 text-text-secondary border-2 border-dashed border-border rounded-field">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-border">
                          <thead className="bg-surface-alt">
                            <tr>
                              <th className="border border-border px-3 py-2 text-right text-body-xs font-medium text-text-secondary">
                                کد
                              </th>
                              <th className="border border-border px-3 py-2 text-right text-body-xs font-medium text-text-secondary">
                                نام
                              </th>
                              <th className="border border-border px-3 py-2 text-center text-body-xs font-medium text-text-secondary">
                                تعداد
                              </th>
                              <th className="border border-border px-3 py-2 text-center text-body-xs font-medium text-text-secondary">
                                واحد
                              </th>
                              <th className="border border-border px-3 py-2 text-left text-body-xs font-medium text-text-secondary">
                                قیمت واحد
                              </th>
                              <th className="border border-border px-3 py-2 text-left text-body-xs font-medium text-text-secondary">
                                جمع
                          ...
                          <tbody className="divide-y divide-border">
                            {invoice.items?.map((item) => (
                              ...
                              >
                                <td className="border border-border px-3 py-2 text-body-sm font-mono text-center text-text-primary">
                                  {item.item_code || "—"}
                                </td>
                                <td className="border border-border px-3 py-2 text-body-sm text-text-primary">
                                  {item.item_id ? (
                                    <button
                                      onClick={() => {
                                        onClose();
                                ...
                                <td className="border border-border px-3 py-2 text-body-sm text-left text-text-primary">
                                  {formatPersianCurrency(item.unit_price)}
                                </td>
                                <td className="border border-border px-3 py-2 text-body-sm font-medium text-left text-text-primary">
                      ...
                      <div className="mt-4 pt-4 border-t border-border">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-primary text-primary-fg rounded-field hover:bg-primary-hover disabled:opacity-50 whitespace-nowrap"
                          >
