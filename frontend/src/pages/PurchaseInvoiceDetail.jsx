// src/pages/PurchaseInvoiceDetail.jsx
...
export default function PurchaseInvoiceDetail() {
  ...
  const handlePaymentUpdate = async () => {
    ...
    try {
      await updatePurchaseInvoicePayment(id, { paid_amount: newAmount });
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="space-y-3">
              <InfoRow
                ...
                highlight
              />
              <InfoRow label="فروشنده" value={invoice.supplier_name || "—"} />
              <InfoRow label="تاریخ" value={formatDate(invoice.invoice_date)} />
              <InfoRow
                label="تاریخ ثبت"
                value={formatDate(invoice.created_at)}
              />
              <InfoRow label="ثبت‌کننده" value={invoice.created_by || "—"} />
